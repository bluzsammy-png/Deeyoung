...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { q: "Understanding RSI", a: "Relative Strength Index (0–100) — momentum on a speedometer. 55–72 is the healthy bullish band; above 72 is overbought stretch; below 28 is oversold. DeeYoung rewards the healthy band and discounts extremes.", tags: ["indicators"] },
      ...
      { q: "Understanding portfolio risk", a: "Beyond P&L: sector allocation, concentration (HHI), correlation between holdings, volatility, drawdown, and scenario shocks. DeeYoung explicitly warns when several positions behave like one trade — e.g. NVDA + AMD + SMH.", tags: ["risk"] },
    ],
  },
  {
    id: "sentinel",
